package ui.skins.officeweek 
{
	...
	public class BasicTextField extends ui.TextField
	{	
		...
		public var borderColor:uint = 0x71869c;
		public var fontColor:uint = 0xDDDDDD;
		
		public var fontSize:int;
		
		public function BasicTextField(x:Number=0, y:Number=0, text:String="", width:Number=150, height:Number=50, fontSize:int=16, params:Object=null) 
		{
		...
		protected function drawLabel(text:String):void
		{
			...
			var tf:TextFormat = new TextFormat("Mytype", fontSize, fontColor);
			tf.align = "center";
