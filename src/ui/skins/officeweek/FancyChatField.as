package ui.skins.officeweek 
{
	...
	public class FancyChatField extends ui.TextField
	{	
		...
		public function FancyChatField(x:Number=0, y:Number=0, text:String="", width:Number=150, height:Number=50, fontSize:int=16, params:Object=null) 
		{
		...
		protected function drawLabel(text:String):void
		{
			...
			label = drawStamp(width + 10, t.textHeight + 10, 10, 5, t);
